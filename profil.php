...
<img src="images/profil.png"style="width:100%;height:100%;">
</div>
<br>
<div class="box3">
<div class="data1">
<?php
echo "<b>Id Akun</b>";?></div>
<div class="data2">
<?php
...
<div class="data2">
<?php
echo  $_SESSION['nama'];echo "<br>";?></div>
</div>
...
<div class="data2">
<?php
echo $_SESSION['email'];echo "<br>";?></div>
</div>

<div class="box3">
<div class="data1">
<?php
echo "<b>Nomor Telepon</b>";?></div>
<div class="data2">
<?php
echo $_SESSION['nomor_telepon'];echo "<br>";?></div>
</div>
<div class="profilbookmark">
<a href="admin/bookmark.php">Lihat jasa tersimpan</a>
</div>
...
<?php
echo "<div class=\"part2\">";
echo "<form action=\"admin/upload.php\" method=\"post\" enctype=\"multipart/form-data\">
