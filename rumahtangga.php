...
<div class="block6">
	<div class="font3">
		...
		<div class="block2">
<h3><center>Pilihan jasa bidang rumah tangga</center></h3>
<div class="block7">

		<a href="rumahtangga/asistenrumahtangga.php">
		<div class="box7">	
		<img src="images/asistenrumahtangga.png"><br>	
			Asisten Rumah<br>Tangga
			</div>
			</a>
		
		<a href ="rumahtangga/tukangkebun.php">
			<div class="box7">
			<img src="images/tukangkebun.png"><br>	
			Tukang Kebun
			</div>
			</a>
			
			<a href ="rumahtangga/pengasuhbayidananak.php">
			<div class="box7">
			<img src="images/pengasuhbayidananak.png"><br>	
			Pengasuh Bayi dan Anak
			</div>
				</a>
				
				<a href ="rumahtangga/angkutanpindahrumah.php">
			<div class="box7">
			<img src="images/angkutanpindahrumah.png"><br>
